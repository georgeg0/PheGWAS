#' BMI men GWAS summary dataset (made available from GIANT consortium data files)
#'
#' The dataset 'bmimen' is a data.frame object with the summary results of a GWAS analysis.
#'
#' @docType data
#'
#' @usage data(bmimen)
...
#'   \item bmimen is the p_value of the trait
#' }
#'
#' @keywords datasets
#' @return A data frame
...
#' BMI women GWAS summary dataset (made available from GIANT consortium data files)
#'
#' The dataset 'bmiwomen' is a data.frame object with the summary results of a GWAS analysis.
#'
#' @docType data
#'
#' @usage data(bmiwomen)
...
#'   \item BP is the position of the chromosome
#'   \item rsid The SNP ID associated with that position and chromsome
#'   \item bmiwomen is the p_value of the trait
#' }
#'
#' @keywords datasets
#' @return A data frame
